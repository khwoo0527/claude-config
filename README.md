...
```
 ┌─────────────────────────────────────────────────────────────────┐
 │                                                                 │
 │   📋 PRD 작성  ──→  🗺️ ROADMAP 생성  ──→  📐 Phase 계획       │
 │                                                                 │
 │        │              prd-to-roadmap         phase-planner      │
 │        ▼                                                        │
 │                                                                 │
 │   📝 Sprint 계획  ──→  🔨 Sprint 구현  ──→  📦 Sprint 마무리   │
 │                                                                 │
 │   sprint-planner      /sprint-dev {N}      sprint-close         │
 │                                                                 │
 │        │                                        │               │
 │        ▼                                        ▼               │
 │                                                                 │
...
```
                    ...
                    ▼                       ▼
          ┌─────────────────┐    ┌─────────────────────┐
          │ rules/{tech}.md │    │ rules/workflow.md    │
          │  기술 전문 규칙  │    │  워크플로우 규칙      │
          └────────┬────────┘    └──────────┬──────────┘
                   │                        │
                   └────────────┬───────────┘
